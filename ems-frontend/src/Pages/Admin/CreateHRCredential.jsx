      ...
      >
        <Box>
          ...
          <Typography variant="subtitle1" color="#64748b" sx={{ mt: 0.5 }}>
            Admin can create login credentials for HR staff
          </Typography>
        </Box>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <FormControlLabel
                      control={
                        <Switch
                          checked={formData.permissions.addEmployee}
                          onChange={handlePermissionChange('addEmployee')}
                          sx={{
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControlLabel
                      control={
                        <Switch
                          checked={formData.permissions.editEmployee}
                          onChange={handlePermissionChange('editEmployee')}
                          sx={{
                            '& .MuiSwitch-switchBase.Mui-checked': {
                              color: '#2563EB',
                            },
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={handlePermissionChange('deleteEmployee')}
                          sx={{
                            '& .MuiSwitch-switchBase.Mui-checked': {
                              color: '#2563EB',
                            },
...
export default CreateHRCredential;