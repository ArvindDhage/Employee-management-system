...
const EmployeeProfile = ({ employee }) => {
  ...
  const user = employee || defaultEmployee;
  ...
  const personalFields = [
    ...
    {
        label: 'Annual Salary', value: user.annualSalary, icon: <CurrencyRupeeIcon/>
    }
  ];

  // Employee-specific stats
  const stats = [
    { value: '2.4', label: 'Years in Company' },
    { value: '18', label: 'Tasks Completed' },
    { value: '07', label: 'Leave Days Left' },
